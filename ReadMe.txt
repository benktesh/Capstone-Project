...
Task 2: Implement UI for Each Activity and Fragment
  ...
  Build UI for portfolio
  Build mechanism to update user’s data/list  
  Add unit test as much as possible

Task 3: Implement App Widget 
  Implement app widget

Task 4: Create variants and Integrate with Google Play Service
  Create Build Variant
  Create Screen size variant for layout
  Implement Google Play Service

Task 5: Testing App Accessibility and refinement 
  Test accessibility 
